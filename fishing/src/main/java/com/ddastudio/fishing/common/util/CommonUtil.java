...
import com.ddastudio.fishing.common.env.EnvDAO;
import com.ddastudio.fishing.common.env.EnvService;
...
public class CommonUtil {
    ...
    public static String getProperty(String key, String defaultValue) {
        return BeanUtil.getBean(EnvService.class).getProperty(key, defaultValue);
    }

    public static String getProperty(String key) {
        return BeanUtil.getBean(EnvService.class).getProperty(key);
    }
}
